...
let titlesWITHimdb = movies
    .map(movie => movie.title + " - " + movie.imdbRating)
console.log(titlesWITHimdb);
...
let DramaMoviesChristian = movies
  .filter (movie => movie.genre === 'Drama')
  .filter (movie => movie.actors.includes('Christian Bale'))
  .map (movie => movie.title)
console.log(DramaMoviesChristian)

let DramaMoviesTim = movies
  .filter (movie => movie.genre === 'Drama')
  .filter (movie => movie.actors.includes('Tim Robbins'))
  .map (movie => movie.title)
console.log(DramaMoviesTim)
